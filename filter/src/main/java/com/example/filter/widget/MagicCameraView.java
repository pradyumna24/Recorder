...
import com.example.filter.camera.CameraEngine;
import com.example.filter.camera.utils.CameraInfo;
import com.example.filter.encoder.video.TextureMovieEncoder;
import com.example.filter.filter.advanced.MagicBeautyFilter;
import com.example.filter.filter.base.MagicCameraInputFilter;
import com.example.filter.filter.helper.MagicFilterType;
import com.example.filter.helper.SavePictureTask;
import com.example.filter.utils.MagicParams;
import com.example.filter.utils.OpenGlUtils;
import com.example.filter.utils.Rotation;
import com.example.filter.utils.TextureRotationUtil;
