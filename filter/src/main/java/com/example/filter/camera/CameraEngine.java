package com.example.filter.camera;
...
import com.example.filter.camera.utils.CameraUtils;
...
public class CameraEngine {
    ...
    public static com.example.filter.camera.utils.CameraInfo getCameraInfo(){
        com.example.filter.camera.utils.CameraInfo info = new com.example.filter.camera.utils.CameraInfo();
